...
<div class="container-fluid">
	...
	<div class="main row">
		<div  class="col-xs col-sm-8 col-md-9 col-lg-12"><br><hr><br>
			<form class="form-horizontal" role="form" method="POST" action="<?php echo URL;?>Login/cambiarContra" onsubmit="return verificarPasswords()">
				<div class="form-group">
			  	...
			  	<div class="form-group">
			  		...
			  		<button type="button" style="margin-left: 1%;" class="col-lg-1 col-md-1 col-sm-1 col-xs-1 btn btn-danger" onclick="window.location = '<?php echo URL;?>Login/iniciarSesion'">Cancelar</button>
			  	</div>
			</form><hr>
		</div>
	</div>
