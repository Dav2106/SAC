      ...
      <div class="modal-body ">
        <form class="form-group row" action="<?php echo URL;?>ExpedienteMedico/Examen/AgregarExamen" method="POST" onsubmit="return CamposVaciosA()">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <input style="display: none;" type="text" id="idDiag" name="idDiag" value="<?php echo $_SESSION['idLastDgn'];?>"> 
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="form-group row">
                ...
                <label for="example-text-input" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 col-form-label">Descripción:</label> 
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                  <textarea class="form-control" cols="12" rows="2" value="" id="descripcion1" name="descripcion1"></textarea>          
                </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="form-group row">
                <br> 
                <input style="display: none;" type="text" value="" id="idDiag1" name="idDiag1">
