...
<script type="text/javascript" src="<?php echo URL;?>Public/JS/validacionesHospitalizacion.js"></script>
      ...
      <div class="container">
       <form action="<?php echo URL;?>Hospitalizacion/AgregarObsHospit" method="POST">
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 ">
              ...
              <input type="text" style="display: none;" id="idOB" name="idOB" required maxlength="45">
