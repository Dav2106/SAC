...
<script type="text/javascript" src="<?php echo URL;?>Public/JS/validacionesTratamiento.js"></script>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-group row" action="<?php echo URL;?>Tratamiento/AgregarTratamiento" method="POST" onsubmit="return CamposVaciosA()">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
<div class="modal fade" id="modal-2" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-group row" action="<?php echo URL;?>Tratamiento/ModificarTratamiento" method="POST">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <input hidden="hidden" type="datetime" value="<?php echo $fecha;?>" id="fecha1" name="fecha1">     
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 col-form-label">Nombre:</label>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-2 col-form-label">Observaciones</label>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-form-label">
              <textarea class="form-control" name="observaciones1" id="observaciones1" required maxlength="300"></textarea>
            </div><br><br><br><br><br>              
          </div>  
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="modal-footer" >
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body form">
        <form action="<?php echo URL;?>Tratamiento/EliminarTratamiento" method="POST" id="form" class="form-horizontal">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <input hidden="hidden" type="text" id="idTrt" name="idTrt">
...
<div class="container-fluid" style="margin-top: 135px;">
  ...
  <a style="margin-left: 71%;" class="btn btn-danger" href="<?php echo URL;?>Diagnostico/FinalizarConsulta">Finalizar consulta</a>
</div><br>
  ...
  $(document).ready(function(){
      $(document).on('click','#btnReceta',function(){
        ...
        $.ajax({
          ...
          type: 'POST',
          url: '<?php echo URL;?>Receta/iniciarSesion',
          dataType: 'json',
      ...
      $(document).on('click','#btnAdd',function(){
        ...
        if((_producto == null || _producto.length == 0 || /^\s+$/.test(_producto) || _producto == ' ') || 
          ...
          $.ajax({
            data: datos,
            type: 'POST',
            url: '<?php echo URL;?>Receta/AgregarReceta',
            dataType: 'json',
            success: function(response){
              var tabla = $("#receta tbody").html('');
              $.each(response, function(index, record){
      ...
      $(document).on('click','#btnUpd',function(){
        ...
        $.ajax({
          data: datos,
          type: 'POST',
          url: '<?php echo URL;?>Receta/ModificarReceta',
          dataType: 'json',
          success: function(response){
            var tabla = $("#receta tbody").html('');
            $.each(response, function(index, record){
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo URL;?>Tratamiento/mostrarHistorial',
        dataType: 'json',
        success: function(response){
    ...
    $("#btnEliminar").click(function(){
      ...
      $.ajax({
        data: datos,
        type: 'POST',
        url: '<?php echo URL;?>Receta/EliminarReceta',
        dataType: 'json',
        success: function(response){
          $("#modal-7").modal('hide');
          $("#modal-5").modal('show');
