...
<body>
	<div class="container-fluid">
		<div class="col-md-12">
			...
			<div class="col-xs-7">
				<h1 style="margin-left: 50%;">Pacientes atendidos</h1>
			</div>
			<div class="col-xs-4">
		   		<div>
			     	<nav>
	...
	<div id="datos" class="container">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div>
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"></div>
			<button class="btn btn-success" id="btnBuscarMA">Buscar menos atendidos</button>
			<button class="btn btn-danger" id="btnBuscarME">Buscar mas atendidos</button>	
			</div>
		</div>
	</div><br><br>
	<div class="container-fluid">
	...
	<script type="text/javascript">
		$(document).on('click','#btnBuscarMA', function(){
		var fecha1 = $("#fecha1").val();
		var fecha2 = $("#fecha2").val();
		$.ajax({
			data: {"fecha1" : fecha1, "fecha2" : fecha2},
			type: "POST",
			url: "<?php echo URL;?>Reportes/Reportes/mostrarMenosAtendido",
			dataType: 'json',
	...
	<script type="text/javascript">
		$(document).on('click','#btnBuscarME', function(){
		var fecha1 = $("#fecha1").val();
		var fecha2 = $("#fecha2").val();
		$.ajax({
			data: {"fecha1" : fecha1, "fecha2" : fecha2},
			type: "POST",
			url: "<?php echo URL;?>Reportes/Reportes/mostrarMasAtendido",
			dataType: 'json',
			success: function(response){
				console.log(response);
				$.each(response, function(index, record){
