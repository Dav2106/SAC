...
<body>
	<div class="container-fluid">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
				<h1 style="margin-left: 60%;">Historial Clínico</h1>
			</div>
	...
	<div class="container-fluid">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div>
				<table class="table table-stripped table-responsive table-bordered" id="reporte">
					<thead>
						<th>Cédula</th>
						<th>Fecha</th>
						<th>Tipo</th>	
	...
	<script type="text/javascript">
		...
		$.ajax({
			data: "id="+id,
			type: "POST",
			url: "<?php echo URL;?>Reportes/Reportes/histCli",
			dataType: 'json',
