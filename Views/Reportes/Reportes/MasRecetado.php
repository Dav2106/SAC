...
<body>
	<div class="container-fluid">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
				<h1 style="margin-left: 60%;">Medicamento</h1>
			</div>
	...
	<div id="datos" class="container">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div>
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"></div>
			<button class="btn btn-success" id="btnBuscarME">Buscar menos recetadas</button>
			<button class="btn btn-danger" id="btnBuscarMA">Buscar mas recetadas</button>	
			</div>
		</div>
	</div><br><br>
	<div class="container-fluid">
	...
	<script type="text/javascript">
		...
		$.ajax({
			data: {"fecha1" : fecha1, "fecha2" : fecha2},
			type: "POST",
			url: "<?php echo URL;?>Reportes/Reportes/mostrarMenosRecetado",
			dataType: 'json',
			success: function(response){
				$.each(response, function(index, record){
					var row = $("<tr />");
